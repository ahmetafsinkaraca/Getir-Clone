...
export default function Header() {
  return (
    ...
    <div className='bg-brand-color'>
      <div className='container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between sm:gap-10 '>

        <nav className='gap-x-8 flex sm:gap-3'>
          ...
          <a href='#' className='flex p-4 text-white font-semibold hover:bg-brand-new-color text-opacity-80'>
            getiryemek
          </a>
          <a href='#' className='flex p-4 text-white font-semibold hover:bg-brand-new-color text-opacity-80' >
            getirbüyük
        ...
        <nav className='hidden sm:gap-x-2 md:flex gap-x-8 text-sm font-semibold'>
          <a href='#' className='flex items-center gap-x-2 text-white text-opacity-80 font-semibold hover:text-opacity-100 transition-all'>
            <BiGlobe size={20} />
            Türkçe (TR)
          </a>
          <a href='#' className='flex items-center gap-x-2 text-white text-opacity-80 font-semibold hover:text-opacity-100 transition-all'>
    ...
    <div className='container flex mx-auto justify-between items-center md:hidden h-10 py-2'>
      <div className='flex items-center gap-x-2 text-sm font-semibold text-gray-800'>
      <HiLocationMarker size={20} className=' text-primary-brand-color'/> 
      Teslimat Adresi Belirle
      </div>
      <IoIosArrowForward size={20} className=' text-primary-brand-color'/>
    </div>
    </>
  )
}
